...
:root {
  ...
  --color-3-orange-red: #fb5607;
  --color-4-copper: #97512c;
  --color-5-pale-lilac: #dbbadd;
  --color-6-hollywood-cerise: #ff006e;
  --color-7-magic-mint: #a9f0d1;
  --color-8-islamic-green: #00b402;
  --color-9-steel-blue: #489dda;
